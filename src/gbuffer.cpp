...
void GBuffer::blitFramebuffer() {
    ...
    glBindFramebuffer(GL_DRAW_FRAMEBUFFER,
                      0); // write to default framebuffer
                          ...
                          // both the FBO and default framebuffer have to match. the internal formats are implementation
                          // defined. This works on all of my systems, but if it doesn't on yours you'll likely have to
                          // write to the depth buffer in another shader stage (or somehow see to match the default
